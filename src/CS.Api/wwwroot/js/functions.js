EventDomContentLoaded(() => {
    ...
    document.querySelectorAll("input[data-mask='cep']").forEach((el) => {
        ...
        el.addEventListener('input', inputHandler.bind(undefined, ['99.999-999'], 10), false);
    });
    document.querySelectorAll("input[data-mask='altura']").forEach((el) => {
        VMasker(el).maskPattern('9,99');
        el.addEventListener('input', inputHandler.bind(undefined, ['9,99'], 4), false);
    });
})
